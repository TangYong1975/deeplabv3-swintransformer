...
def get_argparser():
    ...
    # Deeplab Options
    parser.add_argument("--model", type=str, default='deeplabv3plus_swimtransformer',
    ...
    parser.add_argument("--ckpt", default='checkpoints/best_deeplabv3plus_swimtransformer_voc_os16.pth', type=str,
